 ...
 * 
 */
public class RelationWizzard extends JDialog implements constants {
  ...
  private AddRelationNameAttributePanel addRelationNameAttributePanel;
   ...
   */
  public RelationWizzard(Database db, RelationSchema rel, WizardEnum type) {
	this.setModal(true);
	...
	database = db;
	relation = rel;
	addRelationNameAttributePanel = new AddRelationNameAttributePanel(relation,
	    database, type);

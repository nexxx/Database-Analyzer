...
public class RelationGraphUpdater implements Runnable {
   ...
   * @param offset
   *          the vertical ofset of the relation
   ...
   * 
   * @param fkCells
   *          the cells to connect by a edge
   * @param visible
   *          determines if the edge should be visible
   */
   ...
   * 
   * @param fk
   *          the ForeignKeyConstraint with the name of the values
   * @param relationCells
   *          the RelationCells containing the Attributes
   ...
   * 
   * @param fk
   *          the fk with the names of the relations

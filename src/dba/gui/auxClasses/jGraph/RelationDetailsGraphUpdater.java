...
public class RelationDetailsGraphUpdater implements Runnable {
   ...
   * 
   * @param graph
   *          the graph as target for insertion
   * @param relation
   *          the relation that should be inserted
   * @param verticalOffset
   *          the vertical offset of the relation
   ...
   * 
   * @param attribute
   *          attribute to get the style for
   ...
   * @param attributeCells
   *          the mxCells containing the attributes
   * @param fds
   *          the functionalDependencies to display
   */
   ...
   *          the mxCells containing the attributes
   * @param fd
   *          the functionalDependency to display
   * @param verticalOffset
   *          the offset between two functionalDependencies
   */
   ...
   * 
   * @param attributes
   *          the cells to draw a node beneath them
   * @param offset
   *          the vertical offset between the cell and the node
   ...
   *          the functionalDependency to display
   * @param nearNodes
   *          the Array of Nodes which are closer to the
   *          attribute-Nodes
   * @param farNodes
   *          the Array of Nodes which are further away of the
   *          attribute-Nodes
   */
